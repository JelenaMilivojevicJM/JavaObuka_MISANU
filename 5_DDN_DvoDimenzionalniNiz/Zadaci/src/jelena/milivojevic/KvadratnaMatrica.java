...
public class KvadratnaMatrica {
	...
	public static void main(String[] args) {
		/*
		 * Učitati dva dvodimenzionalnog niza, a zatim izračunati proizvod elemenata
		 * (kvadratna matrica)
		 */
		...
		// a) Ispisati proizvod elemenata nizova A i B
		for (int i = 0; i < red; i++) {
			for (int j = 0; j < kolona; j++) {
		...
		System.out.println("Izgled niza C (proizvod elemenata niza A i B): ");
		for (int i = 0; i < red; i++) {
			for (int j = 0; j < kolona; j++) {
