...
public class RazlikaElemenata {

	public static void main(String[] args) {
		/* Učitati dva dvodimenzionalnog niza, a zatim izračunati razliku elemenata */
		...
		System.out.println("Izgled niza C (razlika elemenata niza A i B): ");
		for (int i = 0; i < red; i++) {
			for (int j = 0; j < kolona; j++) {
