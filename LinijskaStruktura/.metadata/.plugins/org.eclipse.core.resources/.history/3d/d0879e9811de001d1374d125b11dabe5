...
public class MainOperatori {

	public static void main(String[] args) {
		/*
		 * Deklarisati promenljive a i b i dodeliti im vrednosti 5 i 50. Napisati kod
		 * koji će da sabere, oduzme, pomnoži i podeli promenljive (i deljenje sa
		 * ostatkom) a i b i ispisati to na ekranu.
		 */
