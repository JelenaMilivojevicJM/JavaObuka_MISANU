 ...
 * kako  bismo mogli vrsiti serijalizaciju nad objektima ove klase. Potrebno je da na zeljenu Java klasu, ciju instancu zelimo da serijalizujemo, impementiramo Serializable interface ( java.io. Serializable).
...
public class Grad implements Serializable {
	 ...
	 * koji su kompatibilni sa serijalizacijom. Serijalizovana klasa moze
	 * eksplicitno da ima izrazen svoj serialVersionUID broj deklaracijom polja pod
	 * imenom serialVersionUID, koje moze biti tipa: static, final, i long.
	 */
