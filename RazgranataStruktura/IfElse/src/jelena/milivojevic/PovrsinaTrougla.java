...
public class PovrsinaTrougla {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		/*
		 * Neka su zadati odsečci sa dužinama a, b i c. Sastaviti algoritam i napisati
		 * program za ispitivanje da li zadati odsečci mogu konstruisati trougao i ako
		 * mogu izračunati površinu trougla po formuli: p = 0.25 * Math.sqrt((a + b + c)
		 * * (b + c - a) * (a + c - b) * (a + b - c))
		 */
