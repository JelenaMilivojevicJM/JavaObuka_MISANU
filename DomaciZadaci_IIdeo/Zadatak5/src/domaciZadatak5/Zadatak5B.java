...
public class Zadatak5B {
	...
	public static void main(String[] args) {
		...
		// Racunanje vrednosti x pomocu do-while petlje
		do {
			x0 = x1;
		...
		System.out.println("Za unete vrednosti: n = " + n + ", a = " + a + ", epsilon = " + eps
				+ ", dobijena vrednost x = " + df.format(x1));
		sc.close();
	}
