...
public class MathFunkcije1 {

	public static void main(String[] args) throws NumberFormatException, IOException {
		/*
		 * Sastaviti algoritam i napisati program kojim se izračunava vrednost funkcije
		 * prikazanoj na slici na osnovu unetih vrednosti promenljivih x, y i z. Na
		 * izlazu štampati vrednost funkcije f = (x + y) * (x + z) * Math.sin(x) / (2 *
		 * x - y);
		 */
